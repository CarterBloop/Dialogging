class Macbeth extends Phaser.Scene {
    constructor() {
        ...
        // character variables
        this.firstWitch = null;
        this.secondWitch = null;
        this.thirdWitch = null;
    ...
    create() {
        ...
        this.firstWitch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'firstWitch').setOrigin(0, 1);
        this.secondWitch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'secondWitch').setOrigin(0, 1);
        this.thirdWitch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'thirdWitch').setOrigin(0, 1);
